Component({
  ...
  data: {
    ...
    cursor: 0,
    _keyboardShow: false,
    emojiSource: 'cloud://dev-3gy6ld6nb339550f.6465-dev-3gy6ld6nb339550f-1310723380/相册/心-婚礼.png',
    wishComment: [],
  ...
  methods: {
    ...
    fetchUserInfo() {
      let isAuthorizeUserInfo = null
      let self = this
      try{
        isAuthorizeUserInfo = wx.getStorageSync('isAuthorizeUserInfo')
      }catch(e) {
      }
